...
class MainView(View):
    def get(self,request):
        try:
            ...
            return HttpResponse("soemthing going wrong, please try another browser.")
...
def MakeZip(request):
    ...
    zip_file = open('C:\\Users\\patel\\Documents\\IBL Infotech\\Image Compression\\image_comp\\images.zip', 'rb')
